...
keymaps.git = {
  ...
  get = function(mode, source)
    return keymaps.git[mode](source)
  end,
}
...
keymaps.telescope = {
  ...
  get = function(mode, source)
    return keymaps.telescope[mode](source)
  end
}
...
keymaps.lsp = {
  ...
  get = function(mode, source)
    return keymaps.lsp[mode](source)
  end
}
...
keymaps.cmp = {
  ...
  get = function(mode, source)
    return keymaps.cmp[mode](source)
  end
}
...
keymaps.snippet = {
  ...
  get = function(mode, source)
    return keymaps.snippet[mode](source)
  end
}
